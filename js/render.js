...
const IMERender = (function() {
  ...
  var init = function kr_init(uppercaseFunction, keyTest) {
    ...
    this.pad = document.getElementById('handwriting-pad');
  };
  ...
  var draw = function kr_draw(layout, flags) {
    ...
    // Builds handwriting pad
    if (flags.handwritingPadEnabled) {
      this.pad.innerHTML = '<canvas id="handwriting-pad-canvas" width="500" height="500">';
    } else {
      this.pad.innerHTML = '';
    }
